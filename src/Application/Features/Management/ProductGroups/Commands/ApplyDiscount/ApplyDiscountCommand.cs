...
public sealed record ApplyDiscountCommand(long ProductGroupId, long ProductId, DateOnly DiscountExpiresOn, byte DiscountPercentage) : IRequest<Result<Success>>
{
