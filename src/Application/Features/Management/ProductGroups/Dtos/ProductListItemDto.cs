...
public sealed record ProductListItemDto
{
    ...
    public ProductListItemDto(ProductGroupId id, string title, Money? priceBeforeDiscount, string brand, ProductAverageRating avgerageRating, Money priceNow, ProductImage? primaryImage, byte? discountPercentage, ProductStatus productStatus)
    {
        Id = id.ToString();
        Title = title;
        Brand = brand;
