...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20251210101236_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("CustomerAddressSequence");

            modelBuilder.HasSequence("ReviewSequence");

            modelBuilder.HasSequence("RoleClaimSequence");
            ...
            modelBuilder.Entity("Domain.Customers.Addresses.CustomerAddress", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValueSql("NEXT VALUE FOR [CustomerAddressSequence]");
            ...
            modelBuilder.Entity("Domain.Customers.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Products.Product", b =>
                {
                    ...
                    b.ToTable("Products", null, t =>
                        {
                            t.HasCheckConstraint("CK_Product_Rating", "AverageRating between 1 and 5");
                        });
            ...
            modelBuilder.Entity("Infrastructure.Identity.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValueSql("NEXT VALUE FOR [RoleClaimSequence]");
            ...
            modelBuilder.Entity("Domain.Customers.Addresses.CustomerAddress", b =>
                {
                    b.HasOne("Domain.Customers.User", null)
                        .WithOne("Address")
                        .HasForeignKey("Domain.Customers.Addresses.CustomerAddress", "UserId")
            ...
            modelBuilder.Entity("Domain.Orders.Order", b =>
                {
                    b.HasOne("Domain.Customers.User", "CustomerInfo")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Infrastructure.Identity.User", b =>
                {
                    b.HasOne("Domain.Customers.User", "CustomerInfo")
                        .WithOne()
                        .HasForeignKey("Infrastructure.Identity.User", "UserId");
