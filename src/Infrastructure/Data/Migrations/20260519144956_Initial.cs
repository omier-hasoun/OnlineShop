        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductsGroups_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsGroups_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductsGroups_Users_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProductsGroups_Users_LastModifiedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductReviews_ProductsGroups_ProductsGroupId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductsGroups_BrandId",
                table: "ProductsGroups",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsGroups_CategoryId",
                table: "ProductsGroups",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsGroups_CreatedBy",
                table: "ProductsGroups",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ProductsGroups_LastModifiedBy",
                table: "ProductsGroups",
