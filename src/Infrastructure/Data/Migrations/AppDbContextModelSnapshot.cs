...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Products.Product", b =>
                {
                    ...
                    b.Property<byte>("DefaultDiscountPercentage")
                        .HasColumnType("TINYINT");
                    ...
                    b.Property<short>("MaxQuantityPerCustomer")
                        .HasColumnType("SMALLINT");
                    ...
                    b.ToTable("Products", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_Product_MaxQuantityPerCustomer", "[MaxQuantityPerCustomer]  between 1 and 1000");
                        });
                });

            modelBuilder.Entity("Domain.Products.ProductImages.ProductImage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ProductVariants", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_ProductVariant_DiscountPrice", "[DiscountPrice] between 2 and 499500");

                            t.HasCheckConstraint("CK_ProductVariant_OriginalPrice", "[OriginalPrice] between 2 and 500000");
                        });
                });
            ...
            modelBuilder.Entity("Domain.ReturnItemRequests.Attachments.ReturnItemRequestAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("ReturnItemRequestId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("ReturnItemRequestId");

                    b.ToTable("ReturnItemRequestAttachments", (string)null);
                });
