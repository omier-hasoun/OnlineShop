        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Details = table.Column<string>(type: "NVARCHAR(3000)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerShippingAddresses_Addresses_AddressId",
                        column: x => x.AddressId,
                        principalTable: "Addresses",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceNow = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    Status = table.Column<string>(type: "VARCHAR(50)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_ProductVariant_OriginalPrice", "[OriginalPrice] between 5 and 500000");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerShippingAddresses_AddressId",
                table: "CustomerShippingAddresses",
                column: "AddressId",
                unique: true);
