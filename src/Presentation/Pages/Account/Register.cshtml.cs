...
namespace Presentation.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public sealed class InputModel
        {
            ...
            [Required]
            [StringLength(UserAccountSettings.UserNameMaxLength, ErrorMessage = "The Username must be at least {2} and at max {1} characters long.", MinimumLength = UserAccountSettings.UserNameMinLength)]
