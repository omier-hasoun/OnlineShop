...
public class CartItemErrors
{
    ...
    public static Error QuantityOutOfRange =>
        Error.Forbidden("CartItem.Quantity.OutOfRange", $"The given quantity number must be between {CartItemRules.MinQuantityValue} and {CartItemRules.MaxQuantityValue} per cart item.");
}
